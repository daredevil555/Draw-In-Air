...
def maskAndId(hsv, Lower_hsv, Upper_hsv):
...
def drawOnScreen(points, colors, frame, paintWindow):
...
def startPaintLoop(parameters):
    ...
    paintWindow = createPaintWindow(parameters["colors"])
    ...
    while True:
        ...
        drawOnScreen(points, parameters["colors"], frame, paintWindow)
